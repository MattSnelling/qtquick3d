...
#define QML_WRITABLE_PROPERTY(type, name, defaultValue) \
    protected: \
...
#define QML_WRITABLE_PROPERTY_NODEF(type, name) \
    protected: \
        Q_PROPERTY (type name READ get_##name WRITE set_##name NOTIFY name##Changed) \
    private: \
        type m_##name; \
...
#define QML_READONLY_PROPERTY(type, name, defaultValue) \
    protected: \
...
#define QML_READONLY_PROPERTY_NODEF(type, name) \
    protected: \
        Q_PROPERTY (type name READ get_##name NOTIFY name##Changed) \
    private: \
        type m_##name; \
...
#define QML_CONSTANT_PROPERTY(type, name, value) \
    protected: \
        Q_PROPERTY (type name READ get_##name CONSTANT) \
    private: \
        type m_##name = static_cast< type >(value); \
    public: \
        type get_##name () const { \
            return m_##name ; \
        } \
...
#define QML_CONSTANT_PROPERTY_NODEF(type, name) \
    protected: \
        Q_PROPERTY (type name READ get_##name CONSTANT) \
    private: \
        type m_##name; \
